<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ancash.aspx.vb" Inherits="ancash" %>
...
<body>
    ...
    <asp:Panel ID="Panel1" runat="server" GroupingText="Información">
        <asp:Label ID="lbldatos" runat="server" Text="1 148 000 habitantes"></asp:Label>
        <br />
        <br />
