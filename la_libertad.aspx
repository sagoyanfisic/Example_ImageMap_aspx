<%@ Page Language="VB" AutoEventWireup="false" CodeFile="la_libertad.aspx.vb" Inherits="la_libertad" %>
...
<body>
    ...
    <asp:Panel ID="Panel1" runat="server" GroupingText="Información">
        <asp:Label ID="lbldatos" runat="server" Text="1 859 640  habitantes"></asp:Label>
        <br />
        <br />
