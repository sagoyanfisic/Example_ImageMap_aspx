<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ica.aspx.vb" Inherits="ica" %>
...
<body>
    ...
    <asp:Panel ID="Panel1" runat="server" GroupingText="Información">
        <asp:Label ID="lbldatos" runat="server" Text="836 586 habitantes"></asp:Label>
        <br />
        <br />
