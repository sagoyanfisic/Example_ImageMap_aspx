<%@ Page Language="VB" AutoEventWireup="false" CodeFile="lambayeque.aspx.vb" Inherits="lambayeque" %>
...
<body>
    ...
    <asp:Panel ID="Panel1" runat="server" GroupingText="Información">
        <asp:Label ID="lbldatos" runat="server" Text="1 260 650  habitantes"></asp:Label>
        <br />
        <br />
