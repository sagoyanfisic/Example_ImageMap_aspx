<%@ Page Language="VB" AutoEventWireup="false" CodeFile="madrededios.aspx.vb" Inherits="madrededios" %>
...
<body>
    ...
    <asp:Panel ID="Panel1" runat="server" GroupingText="Información">
        <asp:Label ID="lbldatos" runat="server" Text=" 1 039 372  habitantes"></asp:Label>
        <br />
        <br />
